...
namespace Pizzeria
{
    public partial class frm_principal : Form
    {
        ...
        private LlegadaPedido llegadaVehiculoGas;
        private FinCoccionEmpleado1 finServicioCombustibleSurt1;
        private FinCoccionEmpleado1 finServicioCombustibleSurt2;
        private FinCoccionEmpleado1 finServicioCombustibleSurt3;
        private FinCoccionEmpleado1 finServicioCombustibleSurt4;
        private FinDelivery finServicioGasSurt1;
        private FinDelivery finServicioGasSurt2;
        private FinDelivery finServicioGasSurt3;
        private Empleado1 SurtidorCombustible1;
        private Empleado1 SurtidorCombustible2;
        private Empleado1 SurtidorCombustible3;
        private Empleado1 SurtidorCombustible4;
        private Empleado1 SurtidorGas1;
        private Empleado1 SurtidorGas2;
        private Empleado1 SurtidorGas3;
        ...
        Pedido vehiculoActualSurtComb1 = null;
        Pedido vehiculoActualSurtComb2 = null;
        Pedido vehiculoActualSurtComb3 = null;
        Pedido vehiculoActualSurtComb4 = null;
        Pedido vehiculoActualSurtGas1 = null;
        Pedido vehiculoActualSurtGas2 = null;
        Pedido vehiculoActualSurtGas3 = null;
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            ...
            if (validarDatos())
            {
                ...
                //Instanciar Objetos
                llegadaPedido = new LlegadaPedido(mediaLlegadaCombustible);
                llegadaVehiculoGas = new LlegadaPedido(mediaLlegadaGas);
                finServicioCombustibleSurt1 = new FinCoccionEmpleado1(valorAUniformeFinCombustible, valorBUniformeFinCombustible, 1);
                finServicioCombustibleSurt2 = new FinCoccionEmpleado1(valorAUniformeFinCombustible, valorBUniformeFinCombustible, 2);
                finServicioCombustibleSurt3 = new FinCoccionEmpleado1(valorAUniformeFinCombustible, valorBUniformeFinCombustible, 3);
                finServicioCombustibleSurt4 = new FinCoccionEmpleado1(valorAUniformeFinCombustible, valorBUniformeFinCombustible, 4);
                finServicioGasSurt1 = new FinDelivery(valorAUniformeFinGas, valorBUniformeFinGas, 1, cteSumadaAUniformeGas);
                finServicioGasSurt2 = new FinDelivery(valorAUniformeFinGas, valorBUniformeFinGas, 2, cteSumadaAUniformeGas);
                finServicioGasSurt3 = new FinDelivery(valorAUniformeFinGas, valorBUniformeFinGas, 3, cteSumadaAUniformeGas);
                SurtidorCombustible1 = new Empleado1(1, _TipoPedido.Pizza, 0.00, "Libre");
                SurtidorCombustible2 = new Empleado1(2, _TipoPedido.Lomito, 0.00, "Libre");
                SurtidorCombustible3 = new Empleado1(3, _TipoPedido.Hamburguesa, 0.00, "Libre");
                SurtidorCombustible4 = new Empleado1(4, _TipoPedido.DocSandwich, 0.00, "Libre");
                SurtidorGas1 = new Empleado1(1, _TipoPedido.Empanadas, 0.00, "Libre");
                SurtidorGas2 = new Empleado1(2, _TipoPedido.Empanadas, 0.00, "Libre");
                SurtidorGas3 = new Empleado1(3, _TipoPedido.Empanadas, 0.00, "Libre");
                ...
                if (relojSimulacion == 0.00)//Calculos los primeros eventos
                {
                    ...
                    if (tiempoAPartirDeDondeMostrar == 0.00 && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)//Veo si tengo que graficar
                    {
                        ...
                        agregarEventoAGrilla(i, true, llegadaPedido, 0);
                ...
                while (relojSimulacion < tiempoFinCorrida)
                {
                    ...
                    if (siguienteEvento is LlegadaPedido)//Si el evento es una llegada de un vehiculo a cargar combustible
                    {
                        int i = 0;
                        ...
                        if (SurtidorCombustible1.Estado == _EstadoEmpleado.Libre || SurtidorCombustible2.Estado == _EstadoEmpleado.Libre || SurtidorCombustible3.Estado == _EstadoEmpleado.Libre || SurtidorCombustible4.Estado == _EstadoEmpleado.Libre)//Busco un surtidor libre
                        {
                            if (SurtidorCombustible1.Estado == _EstadoEmpleado.Libre)//Veo Si surtidor1 esta atendiendo a un vehiculos
                            {
                                SurtidorCombustible1.Estado = _EstadoEmpleado.Ocupado;//Actualizo el estado del Surtidor
                                vehiculoActualSurtComb1 = new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Siendo_Atendido_Conbustible, _TipoPedido.Pizza, 0.00);
                                ...
                                if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                {
                                    ...
                                    agregarDatosAGrila(i, ((LlegadaPedido)siguienteEvento).getNombreEvento());
                                    agregarSurtidoresAGrilla(i);
                            ...
                            else if (SurtidorCombustible2.Estado == _EstadoEmpleado.Libre)//Veo Si surtidor2 esta atendiendo a un vehiculos
                            {
                                SurtidorCombustible2.Estado = _EstadoEmpleado.Ocupado;//Actualizo el estado del Surtidor
                                vehiculoActualSurtComb2 = new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Siendo_Atendido_Conbustible, _TipoPedido.Pizza, 0.00);
                            ...
                            else if (SurtidorCombustible3.Estado == _EstadoEmpleado.Libre)//Veo Si surtidor 3 esta atendiendo a un vehiculos
                            {
                                SurtidorCombustible3.Estado = _EstadoEmpleado.Ocupado;//Actualizo el estado del Surtidor
                                vehiculoActualSurtComb3 = new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Siendo_Atendido_Conbustible, _TipoPedido.Pizza, 0.00);
                            ...
                            else if (SurtidorCombustible4.Estado == _EstadoEmpleado.Libre)//Veo Si surtidor 4 esta atendiendo a un vehiculos
                            {
                                SurtidorCombustible4.Estado = _EstadoEmpleado.Ocupado;//Actualizo el estado del Surtidor
                                vehiculoActualSurtComb4 = new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Siendo_Atendido_Conbustible, _TipoPedido.Pizza, 0.00);
                        ...
                        else if (SurtidorCombustible1.tamañoCola() < colaMaxima || SurtidorCombustible2.tamañoCola() < colaMaxima || SurtidorCombustible3.tamañoCola() < colaMaxima || SurtidorCombustible4.tamañoCola() < colaMaxima)//Si no hay libre busco el primero con poca cola
                        {
                            ...
                            if (SurtidorCombustible1.tamañoCola() < colaMaxima)
                            {
                                ...
                                SurtidorCombustible1.ponerEnCola(new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Esperando_Atencion_Conbustible, _TipoPedido.Pizza, relojSimulacion));
                                ContVehiculosCombustibleIngresanAlSitema++;
                                //Pregunto si tengo que mostrar en grilla
                                if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                {
                            ...
                            else if (SurtidorCombustible2.tamañoCola() < colaMaxima)
                            {
                                ...
                                SurtidorCombustible2.ponerEnCola(new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Esperando_Atencion_Conbustible, _TipoPedido.Pizza, relojSimulacion));
                                ContVehiculosCombustibleIngresanAlSitema++;
                                //Pregunto si tengo que mostrar en grilla
                                if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                {
                            ...
                            else if (SurtidorCombustible3.tamañoCola() < colaMaxima)
                            {
                                ...
                                SurtidorCombustible3.ponerEnCola(new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Esperando_Atencion_Conbustible, _TipoPedido.Pizza, relojSimulacion));
                                ContVehiculosCombustibleIngresanAlSitema++;
                                //Pregunto si tengo que mostrar en grilla
                                if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                {
                            ...
                            else if (SurtidorCombustible4.tamañoCola() < colaMaxima)
                            {
                                ...
                                SurtidorCombustible4.ponerEnCola(new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Esperando_Atencion_Conbustible, _TipoPedido.Pizza, relojSimulacion));
                                ContVehiculosCombustibleIngresanAlSitema++;
                                //Pregunto si tengo que mostrar en grilla
                                if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                {
                    ...
                    else if (siguienteEvento is LlegadaPedido)//Si el evento es una llegada de un vehiculo a cargar gas
                    {
                        int i = 0;
                        identificadorVehiculo++;
                        ...
                        if (SurtidorGas1.Estado == _EstadoEmpleado.Libre || SurtidorGas2.Estado == _EstadoEmpleado.Libre || SurtidorGas3.Estado == _EstadoEmpleado.Libre)
                        {
                            if (SurtidorGas1.Estado == _EstadoEmpleado.Libre)//Veo Si esta atendiendo a un vehiculos
                            {
                                SurtidorGas1.Estado = _EstadoEmpleado.Ocupado;
                                vehiculoActualSurtGas1 = new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Siendo_Atendido_Gas, _TipoPedido.Pizza, 0.00);
                                ...
                                if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                {
                                    ...
                                    agregarEventoAGrilla(i, false, llegadaPedido, 0);
                                    agregarEventoAGrilla(i, true, llegadaVehiculoGas, 0);
                                    agregarDatosAGrila(i, ((LlegadaPedido)siguienteEvento).getNombreEvento());
                                    agregarSurtidoresAGrilla(i);
                                    agregarEventoAGrilla(i, false, finServicioCombustibleSurt1, finServicioCombustibleSurt1.getIdSurtidor());
                            ...
                            else if (SurtidorGas2.Estado == _EstadoEmpleado.Libre)//Veo Si esta atendiendo a un vehiculos
                            {
                                SurtidorGas2.Estado = _EstadoEmpleado.Ocupado;
                                vehiculoActualSurtGas2 = new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Siendo_Atendido_Gas, _TipoPedido.Pizza, 0.00);
                            ...
                            else if (SurtidorGas3.Estado == _EstadoEmpleado.Libre)//Veo Si esta atendiendo a un vehiculos
                            {
                                SurtidorGas3.Estado = _EstadoEmpleado.Ocupado;
                                vehiculoActualSurtGas3 = new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Siendo_Atendido_Gas, _TipoPedido.Lomito, 0.00);
                        ...
                        else if (SurtidorGas1.tamañoCola() < colaMaxima || SurtidorGas2.tamañoCola() < colaMaxima || SurtidorGas3.tamañoCola() < colaMaxima)
                        {
                            if (SurtidorGas1.tamañoCola() < colaMaxima)
                            {
                                ...
                                SurtidorGas1.ponerEnCola(new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Esperando_Atencion_Gas, _TipoPedido.Lomito, relojSimulacion));
                                ContVehiculosGasIngresanAlSitema++;
                                //Pregunto si tengo que mostrar en grilla
                                if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                {
                            ...
                            else if (SurtidorGas2.tamañoCola() < colaMaxima)
                            {
                                ...
                                SurtidorGas2.ponerEnCola(new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Esperando_Atencion_Gas, _TipoPedido.Lomito, relojSimulacion));
                                ContVehiculosGasIngresanAlSitema++;
                                //Pregunto si tengo que mostrar en grilla
                                if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                {
                            ...
                            else if (SurtidorGas3.tamañoCola() < colaMaxima)
                            {
                                ...
                                SurtidorGas3.ponerEnCola(new Pedido("EstadoVehi" + identificadorVehiculo, _EstadoPedido.Esperando_Atencion_Gas, _TipoPedido.Lomito, relojSimulacion));
                                ContVehiculosGasIngresanAlSitema++;
                    ...
                    else if (siguienteEvento is FinDelivery)//Si el evento es un fin de atencion gas
                    {
                        int i = 0;

                        switch (((FinDelivery)siguienteEvento).getIdSurtidor())//Veo cual surtidor termino de cargar
                        {
                            case 1:
                                ...
                                if (SurtidorGas1.tamañoCola() > 0)//Veo si hay vehiculos esperando en cola
                                {
                                    ...
                                    vehiculoActualSurtGas1.Estado = _EstadoPedido.Siendo_Atendido_Gas;
                                    ...
                                    if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                    {
                                        ...
                                        agregarEventoAGrilla(i, false, llegadaPedido, 0);
                                        agregarEventoAGrilla(i, false, llegadaVehiculoGas, 0);
                                        agregarDatosAGrila(i, ((FinDelivery)siguienteEvento).getNombreEvento());
                                        agregarSurtidoresAGrilla(i);
                                        agregarEventoAGrilla(i, false, finServicioCombustibleSurt1, finServicioCombustibleSurt1.getIdSurtidor());
                                        agregarEventoAGrilla(i, false, finServicioCombustibleSurt2, finServicioCombustibleSurt2.getIdSurtidor());
                                        agregarEventoAGrilla(i, false, finServicioCombustibleSurt3, finServicioCombustibleSurt3.getIdSurtidor());
                                ...
                                {
                                    SurtidorGas1.Estado = _EstadoEmpleado.Libre;
                            ...
                            case 2:
                                ...
                                if (SurtidorGas2.tamañoCola() > 0)//Veo si hay vehiculos esperando en cola
                                {
                                    ...
                                    vehiculoActualSurtGas2.Estado = _EstadoPedido.Siendo_Atendido_Gas;
                                ...
                                {
                                    SurtidorGas2.Estado = _EstadoEmpleado.Libre;
                            ...
                            case 3:
                                ...
                                if (SurtidorGas3.tamañoCola() > 0)//Veo si hay vehiculos esperando en cola
                                {
                                    ...
                                    vehiculoActualSurtGas3.Estado = _EstadoPedido.Siendo_Atendido_Gas;
                                ...
                                {
                                    SurtidorGas3.Estado = _EstadoEmpleado.Libre;
                    ...
                    else if (siguienteEvento is FinCoccionEmpleado1)//Si el evento es un fin de atencion combustible
                    {
                        int i = 0;

                        switch (((FinCoccionEmpleado1)siguienteEvento).getIdSurtidor())//Veo si hay vehiculos esperando en cola
                        {
                            case 1:
                                ...
                                if (SurtidorCombustible1.tamañoCola() > 0)//Veo si hay vehiculos esperando en cola
                                {
                                    ...
                                    vehiculoActualSurtComb1.Estado = _EstadoPedido.Siendo_Atendido_Conbustible;
                                    ...
                                    if (tiempoAPartirDeDondeMostrar < relojSimulacion && eventosYaSimuladosYMostrados < cantidadDeEventosAMostrar)
                                    {
                                        ...
                                        agregarEventoAGrilla(i, false, llegadaPedido, 0);
                                        agregarEventoAGrilla(i, false, llegadaVehiculoGas, 0);
                                        agregarDatosAGrila(i, ((FinCoccionEmpleado1)siguienteEvento).getNombreEvento());
                                        agregarSurtidoresAGrilla(i);
                                        agregarEventoAGrilla(i, true, finServicioCombustibleSurt1, finServicioCombustibleSurt1.getIdSurtidor());
                                        agregarEventoAGrilla(i, false, finServicioCombustibleSurt2, finServicioCombustibleSurt2.getIdSurtidor());
                                        agregarEventoAGrilla(i, false, finServicioCombustibleSurt3, finServicioCombustibleSurt3.getIdSurtidor());
                                ...
                                {
                                    SurtidorCombustible1.Estado = _EstadoEmpleado.Libre;
                            ...
                            case 2:
                                ...
                                if (SurtidorCombustible2.tamañoCola() > 0)//Veo si hay vehiculos esperando en cola
                                {
                                    ...
                                    vehiculoActualSurtComb2.Estado = _EstadoPedido.Siendo_Atendido_Conbustible;
                                ...
                                {
                                    SurtidorCombustible2.Estado = _EstadoEmpleado.Libre;
                            ...
                            case 3:
                                ...
                                if (SurtidorCombustible3.tamañoCola() > 0)//Veo si hay vehiculos esperando en cola
                                {
                                    ...
                                    vehiculoActualSurtComb3.Estado = _EstadoPedido.Siendo_Atendido_Conbustible;
                                ...
                                {
                                    SurtidorCombustible3.Estado = _EstadoEmpleado.Libre;
                            ...
                            case 4:
                                ...
                                if (SurtidorCombustible4.tamañoCola() > 0)//Veo si hay vehiculos esperando en cola
                                {
                                    ...
                                    vehiculoActualSurtComb4.Estado = _EstadoPedido.Siendo_Atendido_Conbustible;
                                ...
                                {
                                    SurtidorCombustible4.Estado = _EstadoEmpleado.Libre;
        ...
        private void agregarEventoAGrilla(int i, bool conRandom, Evento evento, int idSurt)
        {
            ...
            else if (evento is LlegadaPedido)
            {
                ...
                if (conRandom)
                {
                    dgvResultados.Rows[i].Cells["colRNDLlegadaGas"].Value = ((LlegadaPedido)evento).getRandom();
                    dgvResultados.Rows[i].Cells["colTiempoLlegadaGas"].Value = ((LlegadaPedido)evento).getTiempoEntreLlegada();
                }
                dgvResultados.Rows[i].Cells["colProxLlegadaGas"].Value = ((LlegadaPedido)evento).getProximaLlegada();
            ...
            else if (evento is FinCoccionEmpleado1)
            {
                ...
                if (conRandom)
                {
                    dgvResultados.Rows[i].Cells["colRNDFinCombustible"].Value = ((FinCoccionEmpleado1)evento).getRandom();
                    dgvResultados.Rows[i].Cells["colTiempoFinCombustible"].Value = ((FinCoccionEmpleado1)evento).getTiempoEntreLlegada();
                }
                ...
                switch (idSurt)
                {
                    case 1:
                        ...
                        if (((FinCoccionEmpleado1)evento).getProximaLlegada() != 0)
                        {
                            dgvResultados.Rows[i].Cells["colFinCombustibleServ1"].Value = ((FinCoccionEmpleado1)evento).getProximaLlegada();
                        }
                        break;
                    case 2:
                        ...
                        if (((FinCoccionEmpleado1)evento).getProximaLlegada() != 0)
                        {
                            dgvResultados.Rows[i].Cells["colFinCombustibleServ2"].Value = ((FinCoccionEmpleado1)evento).getProximaLlegada();
                        }
                    ...
                    case 3:
                        ...
                        if (((FinCoccionEmpleado1)evento).getProximaLlegada() != 0)
                        {
                            dgvResultados.Rows[i].Cells["colFinCombustibleServ3"].Value = ((FinCoccionEmpleado1)evento).getProximaLlegada();
                        }
                    ...
                    case 4:
                        ...
                        if (((FinCoccionEmpleado1)evento).getProximaLlegada() != 0)
                        {
                            dgvResultados.Rows[i].Cells["colFinCombustibleServ4"].Value = ((FinCoccionEmpleado1)evento).getProximaLlegada();
                        }
        ...
        private void agregarTodosLosVehiculos(int i)
        {
            ...
            foreach (Pedido vehi in SurtidorCombustible1.getCola())
            {
                agregarVehiculoAGrilla(vehi, i);
            }
            foreach (Pedido vehi in SurtidorCombustible2.getCola())
            {
                agregarVehiculoAGrilla(vehi, i);
            }
            foreach (Pedido vehi in SurtidorCombustible3.getCola())
            {
                agregarVehiculoAGrilla(vehi, i);
            }
            foreach (Pedido vehi in SurtidorCombustible4.getCola())
            {
                agregarVehiculoAGrilla(vehi, i);
            }
            foreach (Pedido vehi in SurtidorGas1.getCola())
            {
                agregarVehiculoAGrilla(vehi, i);
            }
            foreach (Pedido vehi in SurtidorGas2.getCola())
            {
                agregarVehiculoAGrilla(vehi, i);
            }
            foreach (Pedido vehi in SurtidorGas3.getCola())
            {
                agregarVehiculoAGrilla(vehi, i);
            }
        ...
        private void agregarVehiculoAGrilla(Pedido vehiculo, int i)
        {
            if (vehiculo != null)
            {
                try
